...
def demo_repetition_weighting():
    ...
    from config import ENABLE_REPETITION_WEIGHTING
    
    if not ENABLE_REPETITION_WEIGHTING:
...
def main():
    ...
    print("\n")
    print("╔" + "=" * 78 + "╗")
    print("║" + " " * 20 + "EXPLAINABILITY DEMONSTRATION" + " " * 30 + "║")
    print("║" + " " * 15 + "TN Police TOR Metadata Correlation" + " " * 28 + "║")
    print("╚" + "=" * 78 + "╝")
